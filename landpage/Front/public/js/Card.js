export const Card = {
    createCard: function (Nombre, content, n) {
        return `<div class="card mb-4 p-5 col-lg-3">
            ...
            <div id="button_${n}" class="container" data-bs-toggle="modal" data-bs-target="#exampleModal">
                <button id="button_${n}" class="btn btn-secondary">Ver</button>
            </div>
        </div>`;
    }
}