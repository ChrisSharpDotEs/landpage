...
<body>
    <header role="header">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarTogglerDemo">
                    <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                        <li class="nav-item mr-4 mb-2 mb-lg-0 px-2">
                            <a href="#js-scroll-to-section" class="nav-link">
                                <i class="fas fa-cubes u-font-size-90 mr-1"></i> ABOUT ME
                            </a>
                        </li>
                        <li class="nav-item mr-4 mb-2 mb-lg-0 px-2">
                            <a class="nav-link" href="#">
                                <i class="fas fa-cube u-font-size-90 mr-1"></i> EXPERIENCIA
                            </a>
                        </li>
                        <li class="nav-item mr-4 mb-2 mb-lg-0 px-2">
                            <a class="nav-link" href="src/views/error/notfound.html">
                                <i class="fas fa-book u-font-size-90 mr-1"></i> FORMACIÓN
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <section class="js-parallax u-promo-block" style="">
